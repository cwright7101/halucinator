...
void qmp_init_marshal(QmpCommandList *cmds)
{
    ...
    qmp_register_command(cmds, "avatar-armv7m-enable-irq",
                         qmp_marshal_avatar_armv7m_enable_irq, 0, 0);
#endif /* defined(CONFIG_AVATAR) && defined(TARGET_ARM) */
#if defined(CONFIG_AVATAR) && defined(TARGET_ARM)
    qmp_register_command(cmds, "avatar-armv7m-disable-irq",
                         qmp_marshal_avatar_armv7m_disable_irq, 0, 0);
#endif /* defined(CONFIG_AVATAR) && defined(TARGET_ARM) */
#if defined(CONFIG_AVATAR) && defined(TARGET_ARM)
    qmp_register_command(cmds, "avatar-armv7m-inject-irq",
                         qmp_marshal_avatar_armv7m_inject_irq, 0, 0);
#endif /* defined(CONFIG_AVATAR) && defined(TARGET_ARM) */
#if defined(CONFIG_AVATAR) && defined(TARGET_ARM)
    qmp_register_command(cmds, "avatar-armv7m-ignore-irq-return",
                         qmp_marshal_avatar_armv7m_ignore_irq_return, 0, 0);
#endif /* defined(CONFIG_AVATAR) && defined(TARGET_ARM) */
#if defined(CONFIG_AVATAR) && defined(TARGET_ARM)
    qmp_register_command(cmds, "avatar-armv7m-unignore-irq-return",
                         qmp_marshal_avatar_armv7m_unignore_irq_return, 0, 0);
#endif /* defined(CONFIG_AVATAR) && defined(TARGET_ARM) */
#if defined(CONFIG_AVATAR) && defined(TARGET_ARM)
    qmp_register_command(cmds, "avatar-armv7m-set-vector-table-base",
                         qmp_marshal_avatar_armv7m_set_vector_table_base, 0, 0);
#endif /* defined(CONFIG_AVATAR) && defined(TARGET_ARM) */
}
