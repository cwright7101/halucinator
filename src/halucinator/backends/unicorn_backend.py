...
class UnicornBackend(ARMHalMixin, HalBackend):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        import os as _os0
        self._fast_bp = _os0.environ.get("HAL_FAST_BP") == "1"
        self._fast_bp_active = False
    ...
    def init(self) -> None:
        ...
        if self._fast_bp_active:
            ...
            log.info("UnicornBackend: HAL_FAST_BP -- per-address breakpoint "
                     "hooks (no global per-instruction code hook)")
        else:
            if self._fast_bp:
                log.warning("UnicornBackend: HAL_FAST_BP ignored -- a per-"
    ...
    # snapshot_lab.py. This is the fast checkpoint the fuzzing loop wants.
    #
    ...
    def restore_state(self, snap: "Snapshot") -> bool:
        ...
        # (e.g. a fuzzing loop snapshotting at a marker bp), the marker
